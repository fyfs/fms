...
public class ImageSoundUploadActivity extends AppCompatActivity implements View.OnClickListener, Post.PostHandler{
    String UPLOAD_TYPE = "";
    String PNUM = "";
    String _id = "";
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_PHOTO_FOR_AVATAR && resultCode == Activity.RESULT_OK) {
            if (data == null) {
                Toast.makeText(this, getString(R.string.desc_cannot_file), Toast.LENGTH_SHORT).show();
                return;
            }
